        ...
        <div class="container cuerpo">
            <div class="row">
               <div class="card col-lg-5 mt-5 mb-5 mx-auto">
                   <h2 class="text-center mt-3">Create a new Adhoc</h2>
                    <label>Projects:</label><br>
                    <form class="form-inline float-left" method="GET" action="servNuevoAdhoc">
                   ...
                   <form action="servNuevoAdhoc" method="post" class="mb-3">
                       <div class="form-group">
                            <label>Title:</label>
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="cboEstadoAdhoc"  id="estadoAdhoc">
                                <option value="" >Select</option>
                       ...
                       <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-primary form-control" onclick="return enviarNuevoAdhoc()">Create</button>   
                    </form>
               </div>
           </div>
        </div>
