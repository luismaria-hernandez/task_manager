        ...
        <div class="container cuerpo">
            <div class="row">
               <div class="card col-lg-5 mt-5 mb-5 mx-auto">
                   <h2 class="text-center mt-3">Create a new Request</h2>
                   <form action="servNuevoReq" method="post" class="mb-3">
                       ...
                       <div class="form-group">
                            <label>Status: </label>
                            <select class="form-control" name="cboEstado" id="status">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="prioridad" name="cboPrioridad">
                                <option value="">Select</option>
                                <c:forEach var="lp" items="${listaPrioridad}">
                                    <option value="${lp.idPrioridadReq}">${lp.prioridadReq}</option>
                                </c:forEach>
                            </select>
                       </div>
                       <div class="form-group">
                            <label>Date:</label>
                            <input  class="form-control" type="date" name="dtpFecha"  id="dtpFecha">
                       </div>
                       <div class="form-group">
                            <label>Time:</label>
                       ...
                       <div class="form-group">
                            ...
                            <textarea class="mt-3 form-control" rows="5" id="adminComment" name="txtAdminComment"></textarea>
                       </div>
                        <button type="submit" class="btn btn-primary form-control" onclick="return enviarRequest()">Create</button>
                    </form>
               </div>
           </div>
        </div>
