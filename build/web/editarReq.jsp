        ...
        <div class="container cuerpo">
            <div class="row">
               <div class="card col-lg-5 mt-5 mb-5 mx-auto">
                   <h2 class="text-center mt-3">Update Request</h2>
                    <form action="servEditarReq" method="post" class="mb-3">
                        <input type="hidden" name="idReq" value="${idReq}">
                        <div class="form-group">
                             <label>Title:</label>
                             <input  class="form-control" type="text"  id="titulo" value="${tituloReq}" name="txtTitulo" >
                        </div>
                        <div class="form-group">
                             <label>Ticket:</label>
                        ...
                        <div class="form-group"> 
                             ...
                             <select class="form-control"   id="prioridad" name="cboPrioridad">
                                 ...
                                 <c:forEach var="lp" items="${listaPrioridad}">
                                     <option value="${lp.idPrioridadReq}" <c:if test="${lp.idPrioridadReq == idPrioridad}">selected</c:if>>${lp.prioridadReq}</option>
                                 </c:forEach>
                             </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                             <label>Date:</label>
                             <input  class="form-control" type="date" value="${fecha}" id="fecha" name="dtpFecha">
                        </div>
                        <div class="form-group">
                             <label>Hora:</label>
                             <input  class="form-control" type="time" value="${hora}" id="hora" name="hora">
                        </div>
                        <div class="form-group">
                             <label>Admin comment:</label>
                             <textarea class="mt-3 form-control" rows="5"  id="txtAdminComment" name="txtAdminComment">${req}</textarea>
                        </div>
                        <button type="submit" class="btn btn-primary form-control" onclick="return enviarUpdateRequest()">Update</button>   
                    </form>
               </div>
           </div>
        </div>
