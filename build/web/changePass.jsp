...
<html lang="en">
    <head>
        ...
        <title>DIRECTV'S TaskManager - My account</title>
    </head>
    <body>
        ...
        <div class="container cuerpo">
           <div class="row">
               <div class="card col-lg-4 mt-5 mx-auto">
                   ...
                   <form method="post" action="servMyAccount">
                        <div class="form-group">
                            <label>Actual password:</label>
                            <input type="password" class="form-control" name="txtActual" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="txtRepeatNew" required>
                        </div>
                   ...
                   <% if(request.getAttribute("mensajeExito")!= null && !request.getAttribute("mensajeExito").equals("")) 
                        {
                   %>
                   <p class="text text-success text-center">${mensajeExito}</p>
                   <%   }
                    ...
                    %>
                    <p class="text text-danger text-center">${mensajeError}</p>
                    <% 
                        }
                    
                        else if(request.getAttribute("mensajeNoCoinciden")!= null && !request.getAttribute("mensajeNoCoinciden").equals(""))
                        { 
                                
                    %>
                    <p class="text text-danger text-center">${mensajeNoCoinciden}</p>
                    <%
                        }
                        
                        else if (request.getAttribute("mensajeInvalid")!= null && !request.getAttribute("mensajeInvalid").equals(""))
                        
                        {

                    %>
                    <p class="text text-danger text-center">${mensajeInvalid}</p>
                    <%
                        }
                        else if (request.getAttribute("mensajeDiferente")!= null && !request.getAttribute("mensajeDiferente").equals(""))
                        
                        {

                    %>
                    <p class="text text-danger text-center">${mensajeDiferente}</p>
                    <%
                        }
                    %>
