...
<html lang="en">
    <head>
        ...
        <title>DIRECTV'S TaskManager - MyAccount</title>
    </head>
    <body>
        ...
        <div class="container cuerpo">
           <div class="row">
               <div class="card col-lg-4 mt-5 mx-auto">
                   <h2 class="text-center mt-3">Change project</h2>
                   <form method="post" action="servEditProject">
                        <div class="form-group">
                            <label>Select the project:</label>
                            <select class="form-control mb-4" name="cboProyectos">
