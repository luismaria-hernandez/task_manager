...
<html lang="en">
    <head>
        ...
        <title>DIRECTV'S TaskManager - Requests </title>
    </head>
    <body>
        ...
        <div class="container cuerpo">
            <div class="row">
                <div class="col-sm-3 col-md-11 col-lg-11 mx-auto card mt-3" >
                    <h2 class="card-title mt-3 border-bottom border-dark">${tituloRequest}</h2>
                    <ul>
                        <li class="mt-4"><b>Ticket:</b> <a href="${linkTicket}">${linkTicket}</a></li>
                        <li class="mt-4"><b>Priority:</b> <div class="tag bg-warning">${prioridad}</div></li>
                        <li class="mt-4"><b>Status:</b> <div class="tag bg-warning">${estado}</div></li>
                        <li class="mt-4"><b>Date:</b> ${fecha}</li>
                        <li class="mt-4"><b>Time:</b> ${hora}</li>
                        <li class="mt-4"><b>Request:</b><p>${requesta}</p></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row ">
                <div class="col-sm-6 col-md-4 col-lg-4 card mt-3 mb-3 mx-auto ">
                    ...
                    <input type="hidden" value="${user}" id="userSession">
                        ...
                        <div class="form-group">
                            ...
                            <select id="cboVersion" class="form-control form-control-sm">
                                ...
                                <option value="v7825">v7825</option>
                    ...
                    <form method="post">
                        <input type="hidden" value="${idReq}" name="txtIdReq">
                        <div class="form-group">
                ...
                <div class="card col-sm-6 col-md-6 col-lg-6 mx-auto mt-3 mb-3">
                    ...
                    %>
                        <c:forEach var="lr" items="${listaRespuestas}">
                            ...
                            <p>${lr.respuesta} - <a href="servEliminarRespReq?id=${lr.idRespReq}&idReq=${idReq}" onclick="return eliminarComentario()"><i class="far fa-trash-alt"></i></a></p>
                ...
                <div class="col-sm-3 col-md-11 col-lg-11 mx-auto card mt-3" >
                    ...
                    <ul>
                        ...
                        <li class="mt-4"><b>Assign to:</b> 
                            <form class="form-inline" action="servAsignarReq" method="get">
                                <div class="form-group">
                                    <input type="hidden" value="${idReq}" name="idReq">
                        ...
                        <li class="mt-4"><b>Assignee:</b><%if (request.getAttribute("valor") != null && request.getAttribute("valor").equals("a")) {%> ${separadoPorComa} - <a href="servEditarAsignadosReq?idReq=${idReq}">Edit</a><%} else {%><p class="text text-muted">Not assigned</p><%}%></li>
                        <li class="mt-4"><b>Request:</b><p>${requesta}</p></li>
                        <a href="servDone?idReq=${idReq}"class="btn btn-info float-right" onclick="return terminarTarea()"><b>DONE</b></a>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-4 card mt-3 mb-3 mx-auto ">
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <textarea class="mt-3 form-control form-control-sm" id="txtResponse" rows="5" name="txtRespuesta" required>ADMIN:</textarea>
                        </div>
                        <button type="submit" class="btn btn-primary form-control form-control-sm" onclick="return sendAlert()">Send</button>
                    </form>
                </div>
