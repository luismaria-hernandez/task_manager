...
public class DTOFixesTres 
{
    ...
    public DTOFixesTres(String tituloFix, String linkTicket, int idPrioridadFix, String fecha, String adminComment, int idEstado, int idSprint) {
