...
@WebServlet(name = "servEliminarRespAdhoc", urlPatterns = {"/servEliminarRespAdhoc"})
public class servEliminarRespAdhoc extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        if(request.getSession().getAttribute("user") != null && request.getSession().getAttribute("permiso").equals(2))
        {
            ...
            int idRespAdhoc = Integer.parseInt(request.getParameter("id"));
            int idAdhoc = Integer.parseInt(request.getParameter("idAdhoc"));
            
            g.eliminarRespuestaAdhoc(idRespAdhoc);
