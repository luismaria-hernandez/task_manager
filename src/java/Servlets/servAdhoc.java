...
@WebServlet(name = "servAdhoc", urlPatterns = {"/servAdhoc"})
public class servAdhoc extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        if (request.getSession().getAttribute("user") != null && request.getSession().getAttribute("permiso").equals(2)) 
        {
            ...
            if (request.getParameter("cboSprints") != null)
            {
                ...
                ArrayList listaAdhoc= g.traerListaAdhoc(idSprint);
                
                request.setAttribute("selSprint", idSprint);
                request.setAttribute("listaAdhoc", listaAdhoc);
                
                RequestDispatcher rd = request.getRequestDispatcher("/adhoc.jsp");
