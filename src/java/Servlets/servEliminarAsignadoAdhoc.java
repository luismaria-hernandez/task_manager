...
@WebServlet(name = "servEliminarAsignadoAdhoc", urlPatterns = {"/servEliminarAsignadoAdhoc"})
public class servEliminarAsignadoAdhoc extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        if(request.getSession().getAttribute("user") != null && request.getSession().getAttribute("permiso").equals(2))
        {
            ...
            g.eliminarAsignadoAdhoc(idAdhoc);
