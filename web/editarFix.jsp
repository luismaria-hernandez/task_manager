        ...
        <div class="container cuerpo">
            <div class="row">
               <div class="card col-lg-5 mt-5 mb-5 mx-auto">
                   <h2 class="text-center mt-3">Update Fix</h2>
                    <form action="servEditarFix" method="post" class="mb-3">
                        <input type="hidden" name="txtIdFix" value="${idFix}">
                        <div class="form-group">
                             <label>Title:</label>
                             <input  class="form-control" type="text"  id="titulo" value="${tituloFix}" name="txtTitulo" >
                        </div>
                        <div class="form-group">
                             <label>Ticket:</label>
                        ...
                        <div class="form-group"> 
                             ...
                             <select class="form-control"   id="prioridad" name="cboPrioridad">
                                 ...
                                 <c:forEach var="lp" items="${listaPrioridad}">
                                     <option value="${lp.idPrioridadFix}" <c:if test="${lp.idPrioridadFix == idPrioridad}">selected</c:if>>${lp.prioridadFix}</option>
                                 </c:forEach>
                             </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                             ...
                             <textarea class="mt-3 form-control" rows="5"  id="txtAdminComment" name="txtAdminComment" >${adminComment}</textarea>
                        </div>
                        <button type="submit" class="btn btn-primary form-control" onclick="return confirmarUpdateFix()">Update</button>   
                    </form>
               </div>
           </div>
        </div>
