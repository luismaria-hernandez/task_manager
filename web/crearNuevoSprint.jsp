        ...
        <div class="container cuerpo">
            <div class="row">
               <div class="card col-lg-5 mt-5 mb-5 mx-auto">
                   <h2 class="text-center mt-3">Create a new Sprint</h2>
                   <form action="servSprints" method="post" class="mb-3">
                       <div class="form-group">
                            <label>Projects: </label>
                            <select class="form-control" name="cboProyectos">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input  class="form-control" type="text" name="txtVer">
                       </div>
