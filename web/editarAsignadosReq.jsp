        ...
        <div class="container cuerpo">
           <div class="row">
               <div class="card col-lg-5 mt-5 mx-auto">
                   <h2 class="text-center mt-3"> Edit asignee</h2>
                   <ul class="datosUsuario">
                       <c:forEach var="la" items="${listaAsignados}">
                           <li>${la.toString()} - <a href="servEliminarAsignadosReq?idUser=${la.idUsuario}&idReq=${idReq}" onclick="return confirmarDeleteAsignado()">Delete</a></li> 
                       </c:forEach>
                   </ul>
               </div>
           </div>
