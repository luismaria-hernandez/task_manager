           ...
           <div class="row">
               <div class="card col-lg-5 mt-5 mx-auto">
                   ...
                   <ul class="datosUsuario">
                       ...
                       <li><b>Last name:</b></li>
                       <p><i>${apellido}</i></p>
                       <li><b>User's privilege:</b></li>
                       <p class="capitalize"><i>${tipoUsuario}</i></p>
                       <li><b>Globant's e-mail address:</b></li>
                       <p><i>${mailGlobant}</i></p>
                       <li><b>Asigned Initials:</b></li>
                       <p><i>${ini}</i></p>
                       <li><b>Asigned Proyect:</b></li>
                       <p><i>${nombreProyecto}</i></p>
                   </ul>
                    <form class="mb-4">
                        <a class="btn btn-primary form-control" href="changePass.jsp">Change password</a>
                    </form>
               </div>
           </div>
        </div>
           ...
           <div class="row">
               <div class="card col-lg-5 mt-5 mx-auto">
                   ...
                   <ul class="datosUsuario">
                       ...
                       <p><i>${ini}</i></p>
                       <li><b>Asigned Proyect:</b></li>
                       <p><i>${nombreProyecto}</i> - <a href="servEditProject"><i>Edit</i></a></p> 
                   </ul>
                    <form class="mb-4">
                        <a class="btn btn-primary form-control" href="changePass.jsp">Change password</a>
                    </form>
