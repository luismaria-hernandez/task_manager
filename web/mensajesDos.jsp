...
<html lang="en">
    <head>
        ...
        <title>DIRECTV'S TaskManager - Messages</title>
    </head>
    <body>
        ...
        <div class="container cuerpo">
            ...
            <div class="row">
                <div class="card col-lg-5 mt-5 mx-auto">
                    ...
                    {
                    %>
                    <h1 class="text text-success">Success!</h1>
                    <p class="text text-success">${mensajeExito}</p>
                    ...
                    %>
                    <h1 class="text text-danger">Error</h1>
                    <p class="text text-danger">${mensajeError}</p>
                    <% 
